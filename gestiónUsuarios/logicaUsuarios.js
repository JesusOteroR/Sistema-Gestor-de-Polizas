  ...
  function registrarUsuario() {
      Swal.fire({
          ...
          preConfirm: () => {
              ...
              const nuevosApellidos = document.getElementById("nuevosApellidos").value.trim();
              ...
              if (nuevoUsuario.length < 6) {
                  Swal.showValidationMessage("El nombre de usuario debe tener al menos 6 caracteres");
                  return;
              }
      ...
      fetch(`http://www.polizaswebapp.somee.com/api/Usuario/${userId}`)
          ...
          .then(user => {
              ...
              Swal.fire({
                  ...
                  showLoaderOnConfirm: true,
                  preConfirm: () => {
                      const modificarContrasena = document.getElementById("modificarContrasena").value.trim();
                      const modificarRepetirContrasena = document.getElementById("modificarRepetirContrasena").value.trim();
                      const modificarNombre = document.getElementById("modificarNombre").value.trim();
                      const modificarApellidos = document.getElementById("modificarApellidos").value.trim();
                      const modificarCargo = document.getElementById("modificarCargo").value.trim();
                      ...
                      return fetch(`http://www.polizaswebapp.somee.com/api/Usuario/${userId}`, {
                          method: "PUT",
                          headers: {
                              "Content-Type": "application/json"
                          },
