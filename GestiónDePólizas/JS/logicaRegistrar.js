document.addEventListener("DOMContentLoaded", () => {
  ...
  document
    .getElementById("btn-guardarPoliza")
  ...
  function registrarAseguradora() {
    Swal.fire({
      ...
      preConfirm: () => {
        const idAseguradora = document
          .getElementById("idAseguradora")
          .value.trim();
        const nombre = document
          .getElementById("nombreAseguradora")
          .value.trim();
        const telefono = document
          .getElementById("telefonoAseguradora")
          .value.trim();
        const direccion = document
          .getElementById("direccionAseguradora")
          .value.trim();
  ...
  function registrarPoliza() {
    ...
    const montoCobertura = document
      .getElementById("montoCobertura")
      .value.trim();
    const fechaInicio = document.getElementById("fechaInicio").value;
    const fechaVencimiento = document.getElementById("fechaVencimiento").value;
    const descripcion = document.getElementById("descripcion").value.trim();
    const idUsuario = document
      .getElementById("usuarioResponsable")
      .value.trim();
